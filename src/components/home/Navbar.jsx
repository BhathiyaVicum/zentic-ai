                ...
                <div className="flex items-center gap-3">
                    ...
                    >
                        <div className="w-6 h-6 relative">
                            ...
                            <span className={`absolute h-0.5 bg-current transition-all duration-300 ease-in-out ${
                                mobileMenuOpen ? "opacity-0 w-0" : "w-6 top-3 opacity-100"
                            }`} />
                            <span className={`absolute h-0.5 w-6 bg-current transform transition-all duration-300 ease-in-out ${
                ...
                <div className="px-6 pb-6 pt-2 bg-black/95 backdrop-blur-lg border-t border-brand-light/20">
                    <div className="flex flex-col gap-4">
                        <a
                            href="#home"
                            onClick={(e) => smoothScroll(e, "home")}
                            className={`transition text-lg py-2 ${
                                activeSection === "home"
